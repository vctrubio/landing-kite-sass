    ...
    return (
        <section id="pricing" className="px-6 py-16 bg-gray-50">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl text-gray-600 text-center mb-16">Start free, scale as you grow. Perfect for kite schools of any size.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-[#0058A6] p-8 rounded-2xl border border-[#0058A6] relative">
                        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                            <span className="bg-white text-[#0058A6] px-4 py-1 rounded-full text-sm font-semibold">Most Popular</span>
                        </div>
