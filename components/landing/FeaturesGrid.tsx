    ...
    return (
        <section className="px-6 py-16">
            <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl font-bold text-gray-900 text-center mb-16">Everything you need to run your kite school</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-yellow-500/20 hover:shadow-lg transition-all">
                        ...
                        <p className="text-gray-600 leading-relaxed">Track student progress, manage bookings, and maintain detailed profiles with languages, sizes, and preferences.</p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-green-500/20 hover:shadow-lg transition-all">
                        ...
                        <p className="text-gray-600 leading-relaxed">Drag-and-drop scheduling with automatic conflict detection and commission management for teachers.</p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-purple-500/20 hover:shadow-lg transition-all">
                        ...
                        <p className="text-gray-600 leading-relaxed">Monitor kite usage, assign equipment to teachers, and track maintenance across all your gear.</p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-blue-500/20 hover:shadow-lg transition-all">
                        ...
                        <p className="text-gray-600 leading-relaxed">Create flexible packages with duration, capacity, and pricing. Automatic lesson generation from bookings.</p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-amber-500/20 hover:shadow-lg transition-all">
                        ...
                        <p className="text-gray-600 leading-relaxed">Track teacher payments, commission rates, and generate financial reports with ease.</p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-teal-500/20 hover:shadow-lg transition-all">
                        ...
                        <p className="text-gray-600 leading-relaxed">Export schedules to CSV, WhatsApp, or PDF. Generate medical reports and track school performance.</p>
                    </div>
                </div>
            </div>
        </section>
