import { HelmetIcon, HeadsetIcon, BookmarkIcon, BookingIcon, KiteIcon, EquipmentIcon, PaymentIcon, FlagIcon, AdminIcon } from '@/components/icons';
...
export const ENTITY_DATA = [
    {
        ...
        link: '/students',
        description: ['Students create bookings.', 'Can only have one active booking at a time.'],
    },
    {
        name: 'Teacher',
        icon: HeadsetIcon,
        ...
        link: '/teachers',
        description: ['Our employees, each has a commission rate for a lesson and earn money.', 'Payments are used to deduct earnings from the total.'],
        many_to_many: [
            {
                name: 'Teacher Kite',
                link: '/teachers',
    ...
    },
    {
        ...
        link: '/packages',
        description: ['Determines the duration, capacity, and kites for the booking.'],
    },
    {
        name: 'Booking',
        icon: BookingIcon,
        ...
        link: '/bookings',
        description: ['Has a start date and end date.', 'References come from user accounts.'],
        many_to_many: [
            {
    ...
    },
    {
        ...
        link: '/lessons',
        description: ['Represents a scheduled lesson, linked to a teacher, booking, and commission.'],
    },
    {
        name: 'Event',
        icon: KiteIcon,
        ...
        link: '/events',
        description: ['Must be derived from a lesson.', 'Has a duration and kite that was used.'],
        many_to_many: [
            {
                name: 'Kite Event',
                link: '/events',
    ...
    },
    {
        ...
        link: '/references',
        description: ['Referenced bookings and user notes.', 'Links bookings to user wallet references.'],
    },
] as const;
