      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Transform every student interaction into profit while reducing administrative time by 80%
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-lg text-gray-600 mb-6">
            Start by automating your business today. Save hours of rescheduling and messaging. 
            Have it all in one place, and notify who needs to be notified (student, teacher, insurance).
          </p>
          <a 
            href="#contact" 
